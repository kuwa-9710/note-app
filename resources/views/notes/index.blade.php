    ...
    <div class="flex w-full mx-auto px-4 md:px-0 bg-gradient-to-r from-sky-100 to-indigo-100 min-h-[calc(100vh-76px)]">
        ...
        <x-main>
            ...
            <form action="/notes/create" method="">
                @csrf
                <button class="flex flex-row items-center justify-center w-full border-2 border-indigo-500 rounded-md py-2 mb-4 text-white bg-indigo-500 shadow-lg">
            ...
            <form action="/pages/create" method="">
                @csrf
                <button class="flex flex-row items-center justify-center w-full border-2 border-indigo-500 rounded-md py-2 mb-6 text-white bg-blue-500 shadow-lg">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                        class="w-5 h-5 mr-2">
                        <path stroke-linecap="round" stroke-linejoin="round"
                            d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0115.75 21H5.25A2.25 2.25 0 013 18.75V8.25A2.25 2.25 0 015.25 6H10" />
