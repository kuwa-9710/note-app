...
<div id="docs-sidebar"
    class="lg:hiden hs-overlay hs-overlay-open:translate-x-0 -translate-x-full transition-all duration-300 transform hidden fixed top-0 left-0 bottom-0 z-[60] w-64 bg-white border-r border-gray-200 pt-7 pb-10 overflow-y-auto scrollbar-y lg:translate-x-0 lg:right-auto lg:bottom-0 dark:scrollbar-y dark:bg-gray-800 dark:border-gray-700">
    ...
    <div class=" top-0 inset-0 px-4 pt-8 overflow-auto pb-6 dark:text-white dark:bg-gray-800">
        <div class="flex place-content-between mb-4 items-center">
            <h2 class="text-slate-800 inline-block font-bold text-2xl dark:text-white"><a href="/notes">Notes</a></h2>
        </div>
        <div>
            <form action="/notes/create" method="">
                @csrf
                <button
                    class="text-indigo-400 flex flex-row items-center justify-center w-full border-2 border-indigo-500 rounded-md py-2 mb-4 hover:text-white hover:bg-indigo-500 hover:shadow-lg">
        ...
        <div class="hs-accordion-group" data-hs-accordion-always-open>
                <div class="hs-accordion active" id="hs-basic-always-open-heading-one">
                    ...
                    {{-- Notes --}}
                    <button
                    class=" hs-accordion-toggle hs-accordion-active:text-indigo-600 py-3 inline-flex items-center place-content-between gap-x-3 w-full font-semibold text-left text-gray-800 transition hover:text-gray-500 dark:hs-accordion-active:text-indigo-500 dark:text-gray-200 dark:hover:text-gray-400"
